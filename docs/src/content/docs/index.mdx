...
<CardGrid stagger>
  ...
  <Card title="WebSocket Support" icon="seti:json">
...
For large applications, choose whichever style your team prefers and stick with it for consistency. If you encounter gaps or limitations, [file an issue](https://github.com/knackstedt/shokupan/issues) - Shokupan solves problems at the fundamental level, not through monkeypatches.
...
<CardGrid>
  ...
  <Card title="WebSockets" icon="seti:json">
    Build real-time apps with [WebSocket routers and controllers](/core/websockets/)
  </Card>
