...
:::tip[Did you know?]
Shokupan dynamically reads your source code and generates a deep **Abstract Syntax Tree (AST)** of your logic. The Dashboard utilizes this analyzed AST to visually represent your application's structure, intelligently draw connections between your routers, controllers, and middlewares, and highlight areas where code was statically unparsable. 

If you want to skip runtime scanning and vastly improve application startup times in production, read our **[AST Generation Guide](/guides/ast-generation/)** to learn how to securely pre-compile the AST tree directly in CI!
:::
